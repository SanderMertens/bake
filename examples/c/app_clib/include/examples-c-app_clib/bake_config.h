...
/* Convenience macro for exporting symbols */
  ...
  #if EXAMPLES_C_APP_CLIB_IMPL && (defined(_MSC_VER) || defined(__MINGW32__))
    #define EXAMPLES_C_APP_CLIB_API __declspec(dllexport)
  #elif EXAMPLES_C_APP_CLIB_IMPL
    #define EXAMPLES_C_APP_CLIB_API __attribute__((__visibility__("default")))
  #elif defined _MSC_VER
    #define EXAMPLES_C_APP_CLIB_API __declspec(dllimport)
  #else
    #define EXAMPLES_C_APP_CLIB_API
  #endif
#else
  #define EXAMPLES_C_APP_CLIB_API
#endif
