...
#ifndef EXAMPLES_C_APP_DEPENDEE_STATIC
  #if EXAMPLES_C_APP_DEPENDEE_IMPL && (defined(_MSC_VER) || defined(__MINGW32__))
    #define EXAMPLES_C_APP_DEPENDEE_API __declspec(dllexport)
  #elif EXAMPLES_C_APP_DEPENDEE_IMPL
    #define EXAMPLES_C_APP_DEPENDEE_API __attribute__((__visibility__("default")))
  #elif defined _MSC_VER
    #define EXAMPLES_C_APP_DEPENDEE_API __declspec(dllimport)
  #else
    #define EXAMPLES_C_APP_DEPENDEE_API
  #endif
#else
  #define EXAMPLES_C_APP_DEPENDEE_API
#endif
